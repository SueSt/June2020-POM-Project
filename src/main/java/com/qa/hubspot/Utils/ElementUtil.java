...
public class ElementUtil extends BasePage{
	...
	public WebElement getElement(By locator) {
		...
		try {
			...
			if (prop.getProperty("highlight").equalsIgnoreCase("yes")) {// this is to control if u want the element to be highlited u say yes or no on the config.properties file
				
			jsUtil.flash(element);// implement the JavaSript Executor through the JavaSriptUtil
			}
